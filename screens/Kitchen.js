...
function Kitchen ({navigation}) {
    ...
    useEffect(() => {
      const reference = ref(db, "/UsersData/EdkZfh7MW0bJ09CZ0I1LMIh6ezm1/writings/kitchen/ledstatus");
      onValue(reference, (snapshot) => {
    ...
    useEffect(() => {
      const reference = ref(db, "/UsersData/EdkZfh7MW0bJ09CZ0I1LMIh6ezm1/writings/kitchen/fanstatus");
      onValue(reference, (snapshot) => {
        ...
        <ScrollView contentContainerStyle={styles.buttons} showsVerticalScrollIndicator={false}>
          <Block column space="between">
            <Block row space="around" style={{ marginVertical: theme.sizes.base }}>
              <TouchableOpacity
                activeOpacity={0.8}
                onPress={() => setLightValue("/UsersData/EdkZfh7MW0bJ09CZ0I1LMIh6ezm1/writings/kitchen/ledstatus")} > 
              ...
              <TouchableOpacity
                activeOpacity={0.8}
                onPress={() => setFanValue("/UsersData/EdkZfh7MW0bJ09CZ0I1LMIh6ezm1/writings/kitchen/fanstatus")} >
                <Block center middle style={styles.button}>
